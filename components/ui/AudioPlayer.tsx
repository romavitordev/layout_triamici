...
export function AudioPlayer() {
  ...
  return (
    <div className="fixed bottom-20 right-5 z-50 flex h-11 w-11 items-center gap-3 overflow-hidden border border-dourado/40 bg-preto/85 px-3 text-branco backdrop-blur transition-[width] duration-300 hover:w-64 md:bottom-5">
